            ...
            success: function(result) {
               // console.log(result);
                if (result.status.name == "ok" && result['data']['current'] != undefined) {
                    ...
                    $('#currentWeather').append("<img id='weatherIcon' src=''></img>" + result['data']['current']['weather']['0']['description']);
                    var weatherUrl = "https://openweathermap.org/img/wn/" + icon + "@2x.png";
                    $('#weatherIcon').attr("src", weatherUrl);
                    var calculated = Math.round(result['data']['current']['wind_speed']);                        
                    $('#wind').html(calculated + 'mph'); 
                    //formatting dates                       
                    ...
                    var time5 = moment(result['data']['hourly']['15']['dt']*1000).format("HH:mm");
                    var time6 = moment(result['data']['hourly']['19']['dt']*1000).format("HH:mm");
                    ...
                    var temp5 = result['data']['hourly']['15']['temp'];
                    var temp6 = result['data']['hourly']['19']['temp'];
    
                    $('#time1').append(result['data']['hourly']['3']['weather']['0']['description'] + "  "+ time1);
                    $('#time2').append(result['data']['hourly']['6']['weather']['0']['description'] + "  "+ time2);
                    $('#time3').append(result['data']['hourly']['9']['weather']['0']['description'] + "  "+ time3);
                    $('#time4').append(result['data']['hourly']['12']['weather']['0']['description'] + "  "+ time4);
                    $('#time5').append(result['data']['hourly']['15']['weather']['0']['description'] + "  "+ time5);
                    $('#time6').append(result['data']['hourly']['19']['weather']['0']['description'] + "  "+ time6);
                    $('#hour1').append(temp1 + "℃");
                    $('#hour2').append(temp2 + "℃");
                    $('#hour3').append(temp3 + "℃");
                    $('#hour4').append(temp4 + "℃");
                    ...
                    var icon5 = result['data']['hourly']['15']['weather']['0']['icon'];
                    var icon6 = result['data']['hourly']['19']['weather']['0']['icon'];
                    ...
                    var weatherUrl5 = "https://openweathermap.org/img/wn/" + icon5 + "@2x.png";
                    var weatherUrl6 = "https://openweathermap.org/img/wn/" + icon6 + "@2x.png";
                    ...
                    $('#weatherIcon5').attr("src", weatherUrl5);
                    $('#weatherIcon6').attr("src", weatherUrl6);
                    //First Day
                    ...
                    $('#time4').append(result['data']['hourly']['12']['weather']['0']['description'] + "  "+ time4);
                    $('#time5').append(result['data']['hourly']['15']['weather']['0']['description'] + "  "+ time5);
                    $('#time6').append(result['data']['hourly']['19']['weather']['0']['description'] + "  "+ time5);
                    $('#hour1').append(temp1 + "℃");
                    $('#hour2').append(temp2 + "℃");
                    $('#hour3').append(temp3 + "℃");
                    $('#hour4').append(temp4 + "℃");
                    ...
                    $("#day2").on('click', function(){
                        $("#currentWeather").empty();
                        $('.weatherHide').hide();
                        $('#temp').html("Max:" + result['data']['daily'][1]['temp']['max'] +"℃" + " Min:"  + result['data']['daily'][1]['temp']['min'] + "℃");
                        var icon = result['data']['daily'][1]['weather']['0']['icon'];
                        $('#currentWeather').append("<img id='weatherIcon' src=''></img>" + result['data']['daily'][1]['weather']['0']['description']);
                        var weatherUrl = "https://openweathermap.org/img/wn/" + icon + "@2x.png";
                        $('#weatherIcon').attr("src", weatherUrl);
                        var calculated = Math.round(result['data']['current']['wind_speed']);  
                        $('#wind').html(calculated + 'mph'); 
                     ...
                     $("#day3").on('click', function(){
                        $("#currentWeather").empty();
                        $('.weatherHide').hide();
                        $('#temp').html("Max:" + result['data']['daily'][2]['temp']['max'] +"℃" + " Min:"  + result['data']['daily'][2]['temp']['min'] + "℃");
                        var icon = result['data']['daily'][2]['weather']['0']['icon'];
                        $('#currentWeather').append("<img id='weatherIcon' src=''></img>" + result['data']['daily'][2]['weather']['0']['description']);
                        var weatherUrl = "https://openweathermap.org/img/wn/" + icon + "@2x.png";
                        $('#weatherIcon').attr("src", weatherUrl);
                        var calculated = Math.round(result['data']['current']['wind_speed']); 
                        $('#wind').html(calculated + 'mph'); 
                    ...
                    $("#day4").on('click', function(){
                        $("#currentWeather").empty();
                        $('.weatherHide').hide();
                        $('#temp').html("Max:" + result['data']['daily'][3]['temp']['max'] +"℃" + " Min:"  + result['data']['daily'][3]['temp']['min'] + "℃");
                        var icon = result['data']['daily'][3]['weather']['0']['icon'];
                        $('#currentWeather').append("<img id='weatherIcon' src=''></img>" + result['data']['daily'][3]['weather']['0']['description']);
                        var weatherUrl = "https://openweathermap.org/img/wn/" + icon + "@2x.png";
                        $('#weatherIcon').attr("src", weatherUrl);
                        var calculated = Math.round(result['data']['current']['wind_speed']);
                        $('#wind').html(calculated + 'mph'); 
